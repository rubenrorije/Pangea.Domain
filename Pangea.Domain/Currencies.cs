...
namespace Pangea.Domain
{
    ...
    /// </summary>
    public class Currencies : IEnumerable<Currency>
    {
        /// <summary>
        ...
        /// </summary>
        private static Func<Currencies> _instanceProvider;
        ...
        public static void SetProvider(Func<Currencies> functionToRetrieveTheInstance)
        {
        ...
        /// <returns>Either the currency that is found, or null when the currency could not be found</returns>
        public Currency Find(int numeric)
        {
